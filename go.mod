...
require (
	...
	github.com/dmachard/coredns-gslb v0.18.1
	github.com/hmonsalv/coredns-doh v0.0.0-20260208143232-7f0c7db07e48
)
...
replace github.com/dmachard/CoreDNS-GSLB => ../CoreDNS-GSLB
